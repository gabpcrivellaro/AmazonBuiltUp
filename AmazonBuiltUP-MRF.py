...
for i in sede_id:
    ...
    CM_T = classifier.confusionMatrix('C_ID', 'classification',[1,2,3,4,5])
    ...
    AT_fe = ee.Feature(None,{'Matriz de confusão':CM_T,'Acurácia Global':acc_glob_t,'Acurácia do produtor':(prod_accuracy_t),'Acurácia do Consumidor':(consu_accuracy_t)})
    ...
    AV_fe = ee.Feature(None,{'Matriz de confusão':CM_V,'Acurácia Global':acc_glob_V,'Acurácia do produtor':(prod_accuracy_V),'Acurácia do Consumidor':(consu_accuracy_V),'Coeficiente de Kappa':(kappa_V)})
